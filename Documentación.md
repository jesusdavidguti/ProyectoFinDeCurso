...
- BackEnd
  ...
  - Uso de las ReponseEntity para estandarizar la respuesta de los puntos de entrada y de lombok para abreviar métidos base (getters y setters)
